These files describes an undirected graph with integer edge costs.
...
The simpler approach, which should already give you a healthy speed-up, is to maintain relevant edges in a heap 
(with keys = edge costs).  
